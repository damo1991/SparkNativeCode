...
object P50Fields_Simple_20Gb_Aggregate {

  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50Fields_Simple_20Gb_Aggregate").master("yarn")
    ...
    val df1= sql("select count(monthofApplying)" +
    ...
    df1.write
      ...
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_aggregate_out")
