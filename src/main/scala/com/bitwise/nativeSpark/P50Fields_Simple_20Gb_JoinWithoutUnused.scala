...
object P50Fields_Simple_20Gb_JoinWithoutUnused {

  def main(args: Array[String]): Unit = {
    val sparkSession = SparkSession
      .builder()
      .appName("P50Fields_Simple_20Gb_JoinWithoutUnused").master("yarn")
    ...
    queryResult.select(outSch: _*).write
      ...
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_JoinWithoutUnused_out")
