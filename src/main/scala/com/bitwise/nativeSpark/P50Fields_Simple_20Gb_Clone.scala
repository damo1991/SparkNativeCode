...
/**
  ...
  */
object P50Fields_Simple_20Gb_Clone {

  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50Fields_Simple_20Gb_Clone").master("yarn")
    ...
    readFile.createOrReplaceTempView("Clone")

    val df0 = spark.sql("From Clone Select *")
    val df1 = spark.sql("From Clone Select *")
    val df2 = spark.sql("From Clone Select *")
    ...
    df0.write
      ...
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_Clone1")
    ...
    df1.write
      ...
      .option("timestampFormat","yyyy/MM/dd HH:mm:ss")
      .mode(SaveMode.Overwrite)
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_Clone2")
    ...
    df2.write
      ...
      .option("timestampFormat","yyyy/MM/dd HH:mm:ss")
      .mode(SaveMode.Overwrite)
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_Clone3")
