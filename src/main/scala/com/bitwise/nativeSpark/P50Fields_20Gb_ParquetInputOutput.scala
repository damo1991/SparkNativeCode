...
object P50Fields_20Gb_ParquetInputOutput {


  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50Fields_20Gb_ParquetInputOutput").master("yarn")
    ...
    val readFile = spark.read.parquet("testData/benchmarking/input/20Gb_50Fields_ParquetFile")

    readFile.write.mode( SaveMode.Overwrite ).parquet("testData/benchmarking/output/20Gb_50Fields_ParquetInputOutput")
  }
