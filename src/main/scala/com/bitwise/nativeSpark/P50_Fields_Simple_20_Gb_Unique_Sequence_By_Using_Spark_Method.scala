...
object P50_Fields_Simple_20_Gb_Unique_Sequence_By_Using_Spark_Method {

  val spark = SparkSession
    .builder()
    .appName("P50_Fields_Simple_20_Gb_Unique_Sequence_By_Using_Spark_Method").master("local")
  ...
  def main(args: Array[String]): Unit = {
    ...
    val readFile = spark.read
      ...
      .schema(schema)
      .csv("C:\\Users\\sandeepv\\datafile_of_2GB")



    val df = readFile.withColumn("sequence", monotonically_increasing_id())
    ...
    df.write
      ...
      .csv("C:\\Users\\sandeepv\\2GB_UniqueSequence_out_Partition_20_Run_6")
  }
