...
object Create_50Fields_20Gb_ParquetFile {


  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("Create_50Fields_20Gb_ParquetFile").master("yarn")
    ...
    readFile.write.mode( SaveMode.Overwrite ).parquet("testData/benchmarking/input/20Gb_50Fields_ParquetFile")
  }
