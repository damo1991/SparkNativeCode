...
object Create_50Fields_20Gb_SequenceFile {


  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("Create_50Fields_20Gb_SequenceFile").master("yarn")
    ...
    val readFile = spark.read
      ...
      readFile.rdd.saveAsObjectFile("testData/benchmarking/input/20Gb_50Fields_SequenceFile")
  }
