...
object P50_Fields_Simple_20Gb_InputOutput {


  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50_Fields_Simple_20Gb_InputOutput").master("yarn")
    ...
    val readFile = spark.read
      ...
      .schema(schema)
      .csv("benchmarking/input/20Gb_50Fields")
      ...
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_InputOutput_out")
  }
