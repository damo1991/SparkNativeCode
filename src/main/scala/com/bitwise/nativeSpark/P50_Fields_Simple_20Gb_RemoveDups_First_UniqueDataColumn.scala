...
/**
  ...
  */
object P50_Fields_Simple_20Gb_RemoveDups_First_UniqueDataColumn {

  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50_Fields_Simple_20Gb_RemoveDups_First_UniqueDataColumn").master("yarn")
    ...
    // for First Record
   val df1 = readFile.dropDuplicates(Array("PAN"))
    ...
    df1.write
      ...
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_RemoveDups_first_out")
