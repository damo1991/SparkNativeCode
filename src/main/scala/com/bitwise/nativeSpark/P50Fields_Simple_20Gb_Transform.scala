...
/**
  ...
  */
object P50Fields_Simple_20Gb_Transform {

  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50Fields_Simple_20Gb_Transform").master("yarn")
    ...
    df.write
      ...
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_transform_out")
  }
