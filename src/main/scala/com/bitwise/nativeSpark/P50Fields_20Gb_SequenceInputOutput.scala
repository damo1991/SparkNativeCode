...
import org.apache.spark.sql.types.{BooleanType, DataTypes, DateType, IntegerType, LongType, StringType, StructField, StructType, TimestampType}


object P50Fields_20Gb_SequenceInputOutput {


  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50Fields_20Gb_SequenceInputOutput").master("yarn")
    ...
    val inputRdd: RDD[Row] = spark.sparkContext.objectFile("testData/benchmarking/input/20Gb_50Fields_SequenceFile")

    val readFile = spark.createDataFrame(inputRdd,schema)

    readFile.rdd.saveAsObjectFile("testData/benchmarking/output/50Fields_20Gb_SequenceInputOutput")
  }
