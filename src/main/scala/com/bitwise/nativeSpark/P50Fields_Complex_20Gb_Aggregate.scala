...
object P50Fields_Complex_20Gb_Aggregate {

  def main(args: Array[String]): Unit = {
    val spark = SparkSession
      .builder()
      .appName("P50Fields_Complex_20Gb_Aggregate").master("yarn")
    ...
    spark.udf.register("myzip",(a:Any,b:Any)=>(a+","+b))
...
"max(mobileNumber),min(mobileNumber),concat_ws(',',collect_list(givennameapplicant)),concat_ws(',',collect_list(POB))" +
    ...
    df1.write
      ...
      .csv("testData/benchmarking/output/50Fields_Complex_20Gb_aggregate_out")
