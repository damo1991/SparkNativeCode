...
/**
  ...
  */
object P50_Fields_Simple_20_Gb_Union_All {


  val spark = SparkSession
    .builder()
    .appName("P50_Fields_Simple_20_Gb_Union_All").master("yarn")
  ...
  def main(args: Array[String]): Unit = {
    ...
    readFile1.createOrReplaceTempView("UnionAllTable1")
    readFile2.createOrReplaceTempView("UnionAllTable2")

    val df1 = sql("select * from UnionAllTable1 UNION ALL select * from UnionAllTable2")
    ...
    df1.write
      ...
      .csv("testData/benchmarking/output/50Fields_Simple_20Gb_UnionAll_out")
